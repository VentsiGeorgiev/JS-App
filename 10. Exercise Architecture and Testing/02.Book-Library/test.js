...
describe('Tests', async function () {
   ...
   it('can create book', async () => {
      ...
      await page.fill('form#createForm >> input[name="title"]', 'Pesho');
      await page.fill('form#createForm >> input[name="author"]', 'JS for black lvl ninjas');
      ...
      expect(data.title).to.be.equal('Pesho');
      expect(data.author).to.be.equal('JS for black lvl ninjas');
